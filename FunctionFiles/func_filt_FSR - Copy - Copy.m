function [FSR] = func_filt_FSR(FSR, varargin)
    ...
    % 
    % func_filt_FSR(X,'gap_size2'). Remove noise spikes. If gap is smaller 
    % than gap_size2. Default gap_size2 to is 300 samples (0.15 sec) 
    %
    ...
    %% (2) Remove noise spikes if gap is less than 300 samples (0.15 sec) 
